...
# 예시) 인덱스 1의 lised_in 열 값 : International TV Shows, TV Dramas, TV Mysteries
...
# 넷플릭스 데이터의 descroption 열 이용한 워드 클라우드 생성
